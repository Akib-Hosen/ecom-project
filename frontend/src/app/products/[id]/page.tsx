                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        ...
                        <button
                            ...
                            disabled={product.stock === 0}
                            className="flex-1 flex items-center justify-center border-2 border-[#0047FF] text-[#0047FF] font-bold py-4 rounded-xl hover:bg-blue-50 transition disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            Buy Now
                        </button>
                    </div>
